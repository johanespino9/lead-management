...
export default new Vuex.Store({
  ...
  actions: {
    ...
    Logout({state, commit}){
      ...
      localStorage.removeItem('visitas2')
    ...
    async getHotels({state,commit}) {
      ...
      await axios.get(state.linkServer+'/hotels', config)
      .then(response =>{
    ...
    async getAllLeads({state, commit}){
      ...
      axios.get(state.linkServer+'/user/leads', config)
      .then((res) => {
    ...
    async getAccounts({state, commit}) {
      ...
      await axios.get(state.linkServer+'/user/accounts', config)
      .then((response) => {
    ...
    async getUsers({state, commit}){
      ...
      await axios.get(state.linkServer+'/user/all', config)
      .then((response) => {
    ...
    async getManagers({state, commit}){
      ...
      let url = state.linkServer+'/role/'+state.roleid+'/manager'
      //console.log('ID',id)
    ...
    async getSegmentos({state, commit}){
      ...
      await axios.get(state.linkServer+'/user/segment', config)
      .then((res) => {
    ...
    async getBranch({state, commit}){
      ...
      let url = state.linkServer+'/branch'
      await axios.get(url, config)
      .then((res) => {
    ...
    async getCategories({state, commit}){
      ...
      let url = state.linkServer+'/category'
      await axios.get(url, config)
      .then((res) => {
    ...
    async getVisits({state, commit}){
      ...
      let url = state.linkServer+'/user/dashboard/visits'
      await axios.post(url, datos, config)
      .then((res) => {
    ...
    async getDashJefes({state, commit}){
      ...
      let url = state.linkServer+'/user/dashboard/jefes'
    ...
    async getDashGerentes({state, commit}){
      let fec = new Date()
      let month = (fec.getMonth() +1) 
      let year = fec.getFullYear()
      let months = ['[Seleccionar todos]',
      ...
      let url = state.linkServer+'/user/dashboard/gerentes'
    ...
    async getReasons({state, commit}){
      ...
      let url = state.linkServer+'/reason'
      await axios.get(url, config)
      .then((res) => {
    ...
    async stateToken({state, commit}){
      ...
      let url = state.linkServer+'/user/exist_token'
      await axios.get(url, config)
      .then(response =>{
